  ...
  return (
    <div className="admin-pronos-page">
      ...
      <div className="admin-lock-card">
        <div>
          <strong>Heure de blocage des pronos</strong>
          <span>Cette heure sera affichee sur la page Pronos pour {selectedJournee.title}.</span>
        </div>

        <input
          className="admin-lock-input"
          type="datetime-local"
          value={selectedJournee.lockAt || ""}
          onChange={(e) =>
            updateSelectedJournee({
          ...
          return (
            <div key={match.id} className={`admin-match-card ${blocked ? "blocked" : ""}`}>
              ...
              <div className="admin-card-actions">
                ...
                <button className="red" type="button" onClick={() => removeMatch(match.id)}>
                  Supprimer
                </button>
              </div>
            </div>
