...
export default function Pronos() {
  ...
  const bonus = data.bonus && data.bonus.length > 0 ? data.bonus.slice(0, 4) : DEFAULT_BONUS;
    ...
    <div className="pronos-page">
      <div className="prono-top">
        <div className="prono-title">
          ...
          <p>3 matchs par ligne. Ligue 1 d'abord, puis les 4 bonus ÃƒÆ’Ã‚Â  la fin.</p>
        </div>
