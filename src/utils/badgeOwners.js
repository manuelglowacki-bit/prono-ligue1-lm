...
function getPlayerFavorite(player, currentPlayer) {
  return (
    ...
    (player === currentPlayer ? localStorage.getItem(FAVORITE_TEAM_KEY) || 'RC Lens' : '')
  );
}
...
function calculatePlayerStats(player) {
  ...
  const currentPlayer = localStorage.getItem(PLAYER_KEY) || 'RC Lens';
...
export function getBadgeOwners() {
  ...
  return BADGES.map((badge) => {
    const ranking = [...playerStats].sort((a, b) => {
